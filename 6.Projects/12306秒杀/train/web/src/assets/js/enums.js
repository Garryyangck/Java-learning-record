...
MESSAGE_TYPE={SYSTEM_MESSAGE:{code:"0",desc:"系统消息"},MEMBER_MESSAGE:{code:"1",desc:"用户消息"}};
MESSAGE_STATUS={UNREAD:{code:"0",desc:"未读"},READ:{code:"1",desc:"已读"},DELETE:{code:"2",desc:"删除"},TOP:{code:"3",desc:"置顶"}};
MARKDOWN={WELCOME:{code:"1",desc:"欢迎",fileName:"welcome.md"},ABOUT:{code:"2",desc:"关于",fileName:"about.md"}};
...
MESSAGE_TYPE_ARRAY=[{code:"0",desc:"系统消息"},{code:"1",desc:"用户消息"}];
MESSAGE_STATUS_ARRAY=[{code:"0",desc:"未读"},{code:"1",desc:"已读"},{code:"2",desc:"删除"},{code:"3",desc:"置顶"}];
MARKDOWN_ARRAY=[{code:"1",desc:"欢迎",fileName:"welcome.md"},{code:"2",desc:"关于",fileName:"about.md"}];
